...
GHG_202109 <- read_csv("202109_GHG_Clean_new.csv")
# GHG_202111 <- <- read_csv("202111_GHG_Clean.csv")

# Merge all synoptic dates together
GHG_all <- rbind(GHG_202011, GHG_202102, GHG_202105, GHG_202106, GHG_202109)

# Some quick plots

ggplot(GHG_all, aes(x= Site, y = CO2_uM)) +
  geom_boxplot()

ggplot(GHG_all, aes(x= Site, y = CH4_uM)) +
  geom_boxplot()

ggplot(GHG_all, aes(x = Sample_Date, y = CH4_uM, color = Site)) +
  geom_point()
