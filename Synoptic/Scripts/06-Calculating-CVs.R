...
synoptic <- read.csv("Merged_synoptic_morph.csv") # All the data

synoptic$Date_corrected <- as.Date(parse_date_time(synoptic$Sample_Date.x, c("mdy", "ymd")))
