...
wCO2_uatm_medhs <- StmCO2fromSamp(tempLab.C=20, tempSite.C=17, kPa=102, gasV=20, waterV=20, pCO2.samp=420, pCO2.hs=0)
...
samp$wCO2_umolm3_med <- FwCO2(tempC = , CO2w.uatm = samp$wCO2_uatm_medhs)
wCO2_umolm3_med <- FwCO2(tempC = 17, CO2w.uatm = wCO2_uatm_medhs)
